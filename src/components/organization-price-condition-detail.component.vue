<template>
  <div>
    <el-row class="header">
      <el-col :span="12"><h4>机构定价条件详情{{type === 'add' ? '录入' : type === 'update' ? '编辑' : type=='check '? '查看':''}}</h4>
      </el-col>
      <el-col :span="12">
    ...
    <el-form ref="goods" :model="organizationPriceCondition" label-width="100px" :rules="rules" style="width: 70%; margin: 20px auto;">
      ...
      <el-form-item label="开始时间" prop="startTime">
        ...
        <el-time-picker v-model="value2" :picker-options="{selectableRange: '18:30:00 - 18:29:59'}" placeholder="任意时间点">
        </el-time-picker>
      </el-form-item>
      <el-form-item label="结束时间" prop="endTime">
        <div class="block">
          <span v-if="type === 'check'" class="demonstration">{{organizationPriceCondition.endTime}}</span>
          <el-date-picker v-else value-format="yyyy-MM-dd" v-model="value1" type="date" placeholder="选择日期">
          </el-date-picker>
        </div>
        <el-time-picker v-model="value3" :picker-options="{selectableRange: '18:30:00 - 20:30:00'}" placeholder="任意时间点">
        </el-time-picker>
      </el-form-item>
    </el-form>
  </div>
