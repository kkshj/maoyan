<template>
  <div>
    <el-row class="header">
      ...
      <el-form ref="goods" :model="orderItemTypeConfirm" label-width="100px" :rules="rules" style="width: 70%; margin: 20px auto;">
        <el-form-item label="订单类型" prop="orderType">
          <el-input v-model="orderItemTypeConfirm.realName"></el-input>
        </el-form-item>
        <el-form-item label="订单行项目" prop="organizationId">
          <el-input v-model="orderItemTypeConfirm.completCheckProfile"></el-input>
        </el-form-item>
        <el-form-item label="简介" prop="text">
          <el-input v-model="orderItemTypeConfirm.text"></el-input>
        </el-form-item>
        <el-form-item label="详细介绍" prop="longText">
          <mavon-editor v-model="orderItemTypeConfirm.longText"/>
        </el-form-item>
      </el-form>
  </div>
</template>
...
<script>
  export default {
    name: "orderItemTypeConfirm-detail",
    data () {
      return {
        type: '',
        header: '',
        orderItemTypeConfirm: {},
        rules: {
          realName: [
    ...
    methods: {
      ...
      create () {
        console.log(this.orderItemTypeConfirm)
      },
      update () {
