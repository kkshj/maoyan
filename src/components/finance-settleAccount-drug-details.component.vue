<template>
  <div>
  	<h5 class="header"><span @click='clickDack'>问诊结账</span> > 人名</h5>
    <el-row :gutter="20">
<el-col :span="6">
          <div class="block">
          <el-date-picker value-format="yyyy-MM-dd" v-model="condition.payTime" type="daterange" unlink-panels range-separator="—" start-placeholder="开始日期" end-placeholder="结束日期">
          </el-date-picker>
        </div>
      </el-col>    	
      <el-col :span="3">
      ...
      <el-col :span="3">
        ...
        !condition.orderNumber && !condition.payment" @click="resetCondition()">重置</el-button>     
      </el-col>
    </el-row>
      <el-table ref="multipleTable" tooltip-effect="dark" class='tableList' :data="tableData" border style="width: 100%" v-loading='loading' @selection-change="handleSelectionChange">
        ...
        <el-table-column align='center' label="药企分成金额" prop='refundState'></el-table-column>
        <el-table-column align='center' label="快医分成金额" prop='refundIndex'></el-table-column>
        <el-table-column align='center' label="快递费" prop='refundMoney'></el-table-column>
      </el-table>
      <br/>
