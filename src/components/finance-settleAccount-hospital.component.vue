  ...
  <div>
    <el-row :gutter="20">
      ...
      <el-col :span="3">
        ...
        <el-button type="danger" plain :disabled="!condition.startAndEndTime && !condition.hospital" @click="resetCondition()">重置</el-button>
      </el-col>
    </el-row>
    ...
    <el-table class='tableList' :data="tableData" border style="width: 100%" v-loading="loading">
      ...
      <el-table-column align='center' label="其他扣款" prop='reconcilia'>
        <template slot-scope="scope">
          <el-input class="edit-cell" v-if="scope.row.isEdit" v-model="scope.row.reconcilia"></el-input>
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      ...
      this.$router.push('/finance-settleAccount-hospital-details')
    },
    //下拉框改变状态
    remotestatusMethod() {
