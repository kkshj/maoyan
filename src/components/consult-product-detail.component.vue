...
<template>
  <div>
    <el-row class="header">
      <el-col :span="12"><h4>产品服务信息{{type === 'add' ? '录入' : type === 'update' ? '编辑' : type=='check '? '查看':''}}</h4></el-col>
      <el-col :span="12">
    ...
    <el-form ref="goods" :model="Product" label-position="left"label-width="100px" :rules="rules" style="width: 70%; margin: 20px auto;">
      ...
      <el-form-item label="产品编码" prop="code">
        <span v-if="type === 'check'">{{Product.code}}</span>
        <el-input v-else v-model="Product.code"></el-input>
      </el-form-item>
